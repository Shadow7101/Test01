...
namespace App1.Application.Email
{
    public class SendMail: ISendMail
    {
        ...
        public SendMail(IConfiguration configuration)
        {
            ...
            this._service = new GmailEmailService(configuration);
            this.ApplicationUrl = "http://localhost:64353/";
        }
        ...
        public void SendRegister(Guid id, string email, string name)
        {
            ...
            //corpo += "http://monogp.azurewebsites.net/Home/RegisterEmailConfirme?Id={0}";
            corpo += "\n\n";
        ...
        public void SendRemember(Guid id, string email, string name)
        {
            ...
            //corpo += "http://monogp.azurewebsites.net/Home/RememberEmailConfirme?Id={0}";
            corpo += "\n\n";
